...
from src.config import MODELS_DIR, PROCESSED_DATA_DIR, PROJECT_ROOT, REPORTS_DIR, settings
...
if __name__ == "__main__":
    ...
    sample_data["temperature_target"] = sample_data["temperature"] + np.random.normal(
        0, 2, n_samples
    )
